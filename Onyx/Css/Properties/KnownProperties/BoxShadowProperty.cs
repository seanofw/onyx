...
{
    public sealed record class BoxShadowProperty : StyleProperty
    {
		...
		public override ComputedStyle Apply(ComputedStyle style)
			=> style.WithBoxShadows(Shadows);

		public override ComputedStyle CopyProperty(ComputedStyle dest, ComputedStyle source)
			=> dest.WithBoxShadows(source.BoxShadows);

		public override string ToString()
			=> string.Join(", ", Shadows.Select(s => s.ToString()));

		public BoxShadowProperty AddShadow(Shadow shadow)
