...
{
	public abstract class SelectorFilterPseudoClass : SelectorFilter
	{
		protected abstract string PseudoClassName { get; }

		public override Specificity Specificity => new Specificity(attributeCount: 1);

		protected SelectorFilterPseudoClass(SelectorFilterKind kind)
			: base(kind)
		{
		}
